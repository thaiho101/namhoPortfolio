...
<section id='hero' class="heroSection">
  <div class="heroText">
    ...
    <div class="heroMetrics">
      ...
      <div class="metricBox">
        <span class="metricVal">3.69</span>
    ...
    <div class="heroButtons">
	  ...
	  <a href="/file/Nam_Ho_SWE_Resume.pdf" download='Nam_Ho_SWE_Resume' class="secondaryBtn">RESUMÉ (SWE)</a>
    </div>
  </div>
    ...
    <div class="timelineItem eduTimeline">
      ...
      <div class="glassCard school">
		...
		<div class='companyDuration'>
        	<p class="award"><span style='text-shadow: 0 0 5px white;'>🎓</span> B.S. Software Engineering | GPA: <span class='highlight'>3.69</span></p>
	...
	<div class='projectsLayoutCover'>
		<div class="projectsLayout">
			<div class="projectsList">
				...
				<div class="projectCard" data-preview="beachThemeToggleImageReview">
					<div class="projectText">
						<div class="projectTopLine">
						...
						<p>
						A creative front-end project exploring theme switching, animation, and immersive user experience.
						</p>

						<ul class="projectTextUl">
							<li>Built an <span class="highlight">interactive day/night toggle</span> with smooth UI transitions</li>
							<li>Integrated <span class="highlight">audio effects</span> (ocean waves & ukulele) based on theme state</li>
							<li>Designed animated visuals using <span class="highlight">pure HTML, CSS, and JavaScript</span></li>
						</ul>
			...
			<div class="previewPanel">
				...
				<div id="beachThemeToggleImageReview" class="previewBox fitFrame"></div>
			...
			<div class="glassCard">
				<div class="timelineItemSub">
					...
					<div class="roleBlock role1">
						<h4>Warehouse Manager (Operations & Software Automation)</h4>
